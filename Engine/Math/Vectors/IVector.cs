    ...
    where TVector : IVector<TVector>
{
    ...
    /// </summary>
    static abstract double Distance(
        TVector left,
        TVector right);
    ...
    /// </summary>
    static abstract double DistanceSquared(
        TVector left,
        TVector right);
