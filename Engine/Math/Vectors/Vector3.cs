...
/// </summary>
public readonly struct Vector3(double x = 0, double y = 0, double z = 0) : IVector<Vector3>
{
    /// <summary>
    ...
    /// <inheritdoc />
    public static double Distance(Vector3 left, Vector3 right) => (left - right).Length;
